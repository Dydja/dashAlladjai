<template>
    <GuestLayout title="Je me connecte" @submit="login">
                ...
                <form class="space-y-6" @submit.prevent="emit('submit')" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            ...
                            in</button>
                        <br />
                        J'ai pas encore de compte <router-link to="/about" tabindex="-1">Je veux m'inscrire</router-link>
                    </div>
                </form>
            </div>
        </div>
...
//Emettre un evenement de soumission 
